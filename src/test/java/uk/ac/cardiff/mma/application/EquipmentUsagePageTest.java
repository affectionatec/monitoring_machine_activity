...
public class EquipmentUsagePageTest {
    ...
    @Test
    public void equipmentUsagePageTest() {
        ...
        driver.findElement(By.xpath("/html/body/header/nav/ul/li[3]/dl/dd[2]/a")).click();
        assertTrue(driver.findElement(By.className("component-label")).getText().contains("Usage of equipment"));
        assertTrue(driver.findElement(By.tagName("th")).getText().contains("Equipment name"));
