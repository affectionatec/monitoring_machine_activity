...
public class LaundryPageTest {
    ...
    public void laundryPageTest() {
        ...
        driver.findElement(By.xpath("/html/body/header/nav/ul/li[9]/a")).click();
        assertTrue(driver.findElement(By.tagName("th")).getText().contains("LaundryID"));
